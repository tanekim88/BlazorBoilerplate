...
let ReactAppEnvironmentModule = class ReactAppEnvironmentModule {
};
ReactAppEnvironmentModule = __decorate([
    CustomModule({
        providers: [
            {
...
], ReactAppEnvironmentModule);
export { ReactAppEnvironmentModule };
