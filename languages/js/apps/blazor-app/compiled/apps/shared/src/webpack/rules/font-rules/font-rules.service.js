...
let WebpackFontRulesService = class WebpackFontRulesService extends WebpackRulesBaseService {
    createRule(options) {
...
export { WebpackFontRulesService };
//# sourceMappingURL=font-rules.service.js.map