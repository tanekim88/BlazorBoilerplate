...
let WebpackJsonRulesService = class WebpackJsonRulesService extends WebpackRulesBaseService {
    createRule(options) {
...
export { WebpackJsonRulesService };
//# sourceMappingURL=json-rules.service.js.map