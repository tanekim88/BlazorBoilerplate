...
let AuthWebpackPluginsConfigService = class AuthWebpackPluginsConfigService extends WebpackPluginsConfigService {
};
AuthWebpackPluginsConfigService = __decorate([
    CustomInjectable()
], AuthWebpackPluginsConfigService);
export { AuthWebpackPluginsConfigService };
let AuthWebpackPluginsService = class AuthWebpackPluginsService extends WebpackPluginsService {
};
AuthWebpackPluginsService = __decorate([
    CustomInjectable()
], AuthWebpackPluginsService);
export { AuthWebpackPluginsService };
