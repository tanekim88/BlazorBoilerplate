...
let WebpackSharedAspnetcoreService = class WebpackSharedAspnetcoreService extends webpack_shared_service_1.WebpackSharedService {
    createConfiguration(options) {
        const entry = webpack_watch_entries_plugin_service_1.WebpackWatchEntriesPlugin.getEntries([
            {
                patterns: [path_1.default.resolve(paths_1.sharedPaths.src.web.material.toAbsolutePath(), 'native/**/index.ts')],
                output: {
                    path: path_1.default.resolve(this.environmentService.outputDir, 'native'),
                    prefix: 'Shared_NativeMaterial'
                },
            },
            {
                patterns: [path_1.default.resolve(paths_1.sharedPaths.src.web.material.toAbsolutePath(), 'native/**/index.lazy.ts'),],
...
], WebpackSharedAspnetcoreService.prototype, "webpackRulesService", void 0);
__decorate([
...
], WebpackSharedAspnetcoreService.prototype, "webpackPluginsService", void 0);
WebpackSharedAspnetcoreService = __decorate([
    process_webpack_providers_1.CustomInjectable()
], WebpackSharedAspnetcoreService);
exports.WebpackSharedAspnetcoreService = WebpackSharedAspnetcoreService;
