...
let AuthEnvironmentModule = class AuthEnvironmentModule {
};
AuthEnvironmentModule = __decorate([
    process_webpack_providers_1.CustomModule({
        providers: [
            {
                provide: configs_1.LOCAL_CONFIG,
                useValue: configs_2.authConfig,
            },
            environment_service_1.AuthEnvironmentService,
        ],
    })
], AuthEnvironmentModule);
exports.AuthEnvironmentModule = AuthEnvironmentModule;
