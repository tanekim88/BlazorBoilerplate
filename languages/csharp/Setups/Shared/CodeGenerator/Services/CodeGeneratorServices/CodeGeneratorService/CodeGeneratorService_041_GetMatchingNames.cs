...
namespace CodeGenerator.Services.CodeGeneratorServices
{
    ...
    {
        public List<TemplateTokenInfo<TData>> GetMatchingNames(
            int maxLength,
            bool isPath,
            ...
            List<TemplateTokenInfo<TData>> toReturn = null)
        {
            ...
            if (objectType.IsEnumerableType() && objectType.IsGenericType)
            {
                ...
                if (isDict)
                {
                    var task = ProcessDictionary(objectType, codeType, text, parentName, isPath, maxLength, toReturn,
               candidates, parentPropertyPaths);
                    task.Wait();
                }
                else
                {
                    ...
                    var task = ProcessList(objectType, codeType, text, parentName, isPath, maxLength, toReturn,
candidates, parentPropertyPaths);
                    task.Wait();
                }
            }
            else
            {
                ...
                if (objectType.IsClass && !isSystemType)
                {
                    ...
                    var task = ProcessClass(objectType, codeType, text, parentName, isPath, maxLength, toReturn,
candidates, parentPropertyPaths);
                    task.Wait();
                }
                else
                {
                    // Primitive
                    var toAdd = new TemplateTokenInfo<TData>
                    {
        ...
        public async Task ProcessClass(Type objectType, TemplateCodeType codeType, string text, string parentName, bool isPath, int maxLength, List<TemplateTokenInfo<TData>> toReturn,
       List<string> candidates, List<string> parentPropertyPaths
    )
        {
        ...
        public async Task ProcessList(Type objectType, TemplateCodeType codeType, string text, string parentName, bool isPath, int maxLength, List<TemplateTokenInfo<TData>> toReturn,
               List<string> candidates, List<string> parentPropertyPaths
            )
        {
        ...
        public async Task ProcessDictionary(Type objectType, TemplateCodeType codeType, string text, string parentName, bool isPath, int maxLength, List<TemplateTokenInfo<TData>> toReturn,
               List<string> candidates, List<string> parentPropertyPaths
            )
        {
