...
describe('AuthWebpackWebpackFixStyleOnlyEntriesService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [webpack_webpack_fix_style_only_entries_service_1.AuthWebpackWebpackFixStyleOnlyEntriesService],
        }).compile();
        service = module.get(webpack_webpack_fix_style_only_entries_service_1.AuthWebpackWebpackFixStyleOnlyEntriesService);
    });
