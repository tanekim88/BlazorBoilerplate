...
let AuthWebpackPreRemoveFilesWebpackPluginService = class AuthWebpackPreRemoveFilesWebpackPluginService extends WebpackPreRemoveFilesWebpackPluginService {
...
export { AuthWebpackPreRemoveFilesWebpackPluginService };
let AuthWebpackRemoveFilesWebpackPluginService = class AuthWebpackRemoveFilesWebpackPluginService extends WebpackRemoveFilesWebpackPluginService {
    createOptions(options) {
        return this.mergeService.mergeOptions(super.createOptions(), {}, options);
    }
};
...
export { AuthWebpackRemoveFilesWebpackPluginService };
