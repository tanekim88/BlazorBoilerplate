...
describe('BlazorAppWebpackCopyWebpackPluginService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [webpack_copy_webpack_plugin_service_1.BlazorAppWebpackCopyWebpackPluginService],
        }).compile();
        service = module.get(webpack_copy_webpack_plugin_service_1.BlazorAppWebpackCopyWebpackPluginService);
    });
