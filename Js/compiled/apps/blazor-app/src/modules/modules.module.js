...
exports.BlazorAppModulesModule = void 0;
...
BlazorAppModulesModule = __decorate([
    process_webpack_providers_1.CustomModule({
        providers: [],
        imports: [utilities_module_1.BlazorAppUtilitiesModule, environment_module_1.BlazorAppEnvironmentModule],
    })
], BlazorAppModulesModule);
exports.BlazorAppModulesModule = BlazorAppModulesModule;
