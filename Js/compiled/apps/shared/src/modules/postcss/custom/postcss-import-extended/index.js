...
//     if (stmt.type === 'import' || stmt.type === 'use') {
...
//           if ((stmt.type !== 'import' && stmt.type !== 'use') || /^(?:[a-z]+:)?\/\//i.test(stmt.uri)) {
//             return;
//           }
...
//               if (child.type === 'import' || child.type === 'use') imports.push(child);
...
//     if (base.toLowerCase().indexOf(excludedPath.toLowerCase()) !== -1) {
//       return;
//     }
//   }
//   ///////////////////////////////
...
//     }
//     ///////////////////////////////////
//     content = content.replace(/#{([-_\w]+?)}/gm, '#($1)');
//     //////////////////////////////////
//     // skip previous imported files not containing @import rules
//     if (state.hashFiles[content] && state.hashFiles[content][media]) return;
//     return processContent(result, content, filename, options).then((importedResult) => {
//       const styles = importedResult.root;
//       result.messages = result.messages.concat(importedResult.messages);
//       if (options.skipDuplicates) {
//         const hasImport = styles.some((child) => {
//           return child.type === 'atrule' && (child.name === 'import' || child.name === 'use');
//         });
//         if (!hasImport) {
...
//   });
// }
// export const postcssImportExtendedFactory = postcss.plugin('postcss-import-extended', AtImport);
