...
describe('WebpackTsconfigPathsWebpackPluginService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [webpack_tsconfig_paths_webpack_plugin_service_1.AuthWebpackTsconfigPathsWebpackPluginService],
        }).compile();
        service = module.get(webpack_tsconfig_paths_webpack_plugin_service_1.AuthWebpackTsconfigPathsWebpackPluginService);
    });
