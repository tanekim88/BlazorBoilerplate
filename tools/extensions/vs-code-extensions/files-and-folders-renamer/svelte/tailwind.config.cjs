...
module.exports = {
	...
	theme: {
		...
		colors:{
			...
			"theme-background":"var(--mdc-theme-background)",
			"theme-surface":"var(--mdc-theme-surface)",
			"theme-on-primary":"var(--mdc-theme-on-primary)",
			"theme-on-secondary":"var(--mdc-theme-on-secondary)",
			"theme-on-surface":"var(--mdc-theme-on-surface)",
			"theme-text-primary-on-light":"var(--mdc-theme-text-primary-on-light)",
			"theme-text-secondary-on-light":"var(--mdc-theme-text-secondary-on-light)",
			"theme-text-hint-on-light":"var(--mdc-theme-text-hint-on-light)",
			"theme-text-disabled-on-light":"var(--mdc-theme-text-disabled-on-light)",
			"theme-text-icon-on-light":"var(--mdc-theme-text-icon-on-light)",
			"theme-text-primary-on-dark":"var(--mdc-theme-text-primary-on-dark)",
			"theme-text-secondary-on-dark":"var(--mdc-theme-text-secondary-on-dark)",
			"theme-text-hint-on-dark":"var(--mdc-theme-text-hint-on-dark)",
			"theme-text-disabled-on-dark":"var(--mdc-theme-text-disabled-on-dark)",
			"theme-text-icon-on-dark":"var(--mdc-theme-text-icon-on-dark)",
			"theme-text-primary-on-background":"var(--mdc-theme-text-primary-on-background)",
			"checkbox-checked-color":"var(--mdc-checkbox-checked-color)",
			"checkbox-unchecked-color":"var(--mdc-checkbox-unchecked-color)",
			"checkbox-ink-color":"var(--mdc-checkbox-ink-color)",
