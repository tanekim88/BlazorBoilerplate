...
<style lang="scss" global>
	...
	:root {
        --mdc-theme-primary: var(--vscode-toolbarHoverBackground, yellow);
		--mdc-theme-secondary: var(--vscode-toolbarHoverBackground, yellow);
		--mdc-theme-background: var(--vscode-toolbarHoverBackground, yellow);
		--mdc-theme-surface: var(--vscode-toolbarHoverBackground, yellow);
		--mdc-theme-on-primary: var(--vscode-editor-foreground, yellow);
		--mdc-theme-on-secondary: var(--vscode-editor-foreground, yellow);
		--mdc-theme-on-surface: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-primary-on-light: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-secondary-on-light: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-hint-on-light: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-disabled-on-light: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-icon-on-light: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-primary-on-dark: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-secondary-on-dark: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-hint-on-dark: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-disabled-on-dark: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-icon-on-dark: var(--vscode-editor-foreground, yellow);
		--mdc-theme-text-primary-on-background: var(--vscode-editor-foreground, yellow);
		--mdc-checkbox-checked-color: var(--vscode-toolbarHoverBackground, yellow);
		--mdc-checkbox-unchecked-color: var(--vscode-toolbarHoverBackground, yellow);
		--mdc-checkbox-ink-color: var(--vscode-toolbarHoverBackground, yellow);
		...
		// --vscode-editorInlayHint-foreground: #252526;
		// --vscode-editorInlayHint-background: #cccccc;
		...
		// --vscode-banner-iconForeground: #75beff;
		...
		// --vscode-filewatcher-error: #f5ed39;
		...
		// --vscode-rust_analyzer-inlayHints\.foreground: rgba(160, 160, 160, 0.94);
		// --vscode-rust_analyzer-inlayHints\.background: rgba(17, 34, 51, 0);
		// --vscode-rust_analyzer-inlayHints\.foreground\.typeHints: rgba(160, 160, 160, 0.94);
		// --vscode-rust_analyzer-inlayHints\.foreground\.chainingHints: rgba(160, 160, 160, 0.94);
		// --vscode-rust_analyzer-inlayHints\.foreground\.parameterHints: rgba(160, 160, 160, 0.94);
		// --vscode-rust_analyzer-inlayHints\.background\.typeHints: rgba(17, 34, 51, 0);
		// --vscode-rust_analyzer-inlayHints\.background\.chainingHints: rgba(17, 34, 51, 0);
		// --vscode-rust_analyzer-inlayHints\.background\.parameterHints: rgba(17, 34, 51, 0);
