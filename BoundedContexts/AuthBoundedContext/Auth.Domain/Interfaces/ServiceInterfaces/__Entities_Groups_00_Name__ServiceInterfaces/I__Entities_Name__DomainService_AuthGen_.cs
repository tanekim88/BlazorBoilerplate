...
namespace Auth.Domain.Interfaces.ServiceInterfaces.__Entities_Groups_00_Name__ServiceInterfaces
{
    public interface I__Entities_Name__DomainService_AuthGen_
    {
        //%S:begin Body
        //%S:end Body
    }
