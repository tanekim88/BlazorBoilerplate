...
namespace SolidApp.Client
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            //builder.Services.AddHttpClient(name: "SolidApp.ServerAPI",
            ...
            //    sp.GetRequiredService<IHttpClientFactory>().CreateClient(name: "SolidApp.ServerAPI"));
