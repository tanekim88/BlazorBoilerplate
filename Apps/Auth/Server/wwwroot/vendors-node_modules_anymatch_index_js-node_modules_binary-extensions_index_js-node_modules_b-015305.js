 ...
 */
exports.id = "vendors-node_modules_anymatch_index_js-node_modules_binary-extensions_index_js-node_modules_b-015305";
exports.ids = ["vendors-node_modules_anymatch_index_js-node_modules_binary-extensions_index_js-node_modules_b-015305"];
exports.modules = {
...
"use strict";
eval("\n\nconst utils = __webpack_require__(/*! ./utils */ \"../../node_modules/braces/lib/utils.js\");\n\nmodule.exports = (ast, options = {}) => {\n  let stringify = (node, parent = {}) => {\n    let invalidBlock = options.escapeInvalid && utils.isInvalidBrace(parent);\n    let invalidNode = node.invalid === true && options.escapeInvalid === true;\n    let output = '';\n\n    if (node.value) {\n      if ((invalidBlock || invalidNode) && utils.isOpenOrClose(node)) {\n        return '\\\\' + node.value;\n      }\n      return node.value;\n    }\n\n    if (node.value) {\n      return node.value;\n    }\n\n    if (node.nodes) {\n      for (let child of node.nodes) {\n        output += stringify(child);\n      }\n    }\n    return output;\n  };\n\n  return stringify(ast);\n};\n\n\n\n//# sourceURL=webpack://blazor-app/../../node_modules/braces/lib/stringify.js?");
