...
namespace Auth.Server.Areas.Identity.Pages.Account
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        {
            if (code == null) return BadRequest(error: "A code must be supplied for password reset.");
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var result =
                await _userManager.ResetPasswordAsync(user: user, token: Input.Code, newPassword: Input.Password);
            if (result.Succeeded) return RedirectToPage(pageName: "./ResetPasswordConfirmation");
